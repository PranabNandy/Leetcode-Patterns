...
## Tips 14
- Bridges in the graph ( Tarjen Algo)
- <img width="1902" height="807" alt="image" src="https://github.com/user-attachments/assets/c2a71bfe-682b-4f0e-9ea4-d5be3e8acec9" />


## Tips 15
- When total size of the matrix is not mentioned clearly
- Here I have used **Disjoint Set** with `Union by Size`
- The way I have implmented the **findPar()**, it is called `Path Compression`
- <img width="1510" height="870" alt="image" src="https://github.com/user-attachments/assets/512dfdc5-7907-483c-ac63-e29c0b6c4c56" />

## Tips 16
- No of strongly connected components 
<img width="1460" height="872" alt="image" src="https://github.com/user-attachments/assets/35d7b469-ab23-4559-ae21-2e0091db6da3" />

## Tips 17
- Articulation Point
- It is having same condition with little difference
```c++
     if (current[node] <= lowTime[adjNode] && parent!=-1)

from "<"   ----->     "<="
           ----->      parent!=-1
```
- <img width="1487" height="915" alt="image" src="https://github.com/user-attachments/assets/1b6b4ca8-5ba2-4d99-8bd6-8763a152c0e7" />
